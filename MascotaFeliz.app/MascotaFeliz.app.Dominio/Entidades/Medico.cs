...
{    
    ...
    {                
        ...
        public virtual int Especializacion { get; set; }
        ...
        public Medico(string nombre, string apellido, string telefono, int tarjetaProfesional, int especializacion, int idCentroVeterinario) 
